 ...
 * @author manfredi
 */
public class ControlloErroriBND extends javax.swing.JFrame {
    ...
    public ControlloErroriBND() {
        initComponents();
    }
    
    public void mostra(SchermataPrincipaleDiocesi schermataDiocesi, GestioneMagazzinoControl gestioneMagazzinoControl){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Errori Diocesi");
    ...
    private void IndietroButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IndietroButtonActionPerformed
        if(this.TabellaErrori.getRowCount() > 20){
            ...
            this.gestioneMagazzinoControl.rimuoviErrori();
        }
        this.setVisible(false);
        this.gestioneMagazzinoControl.schermataDiocesi.setVisible(true);
    }//GEN-LAST:event_IndietroButtonActionPerformed

    public void mostraErrori(List<Errore> e){
        DefaultTableModel model = new DefaultTableModel();
        
        model.addColumn("Polo Coinvolto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlloErroriBND.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlloErroriBND().setVisible(true);
            }
        });
    }

 ...
 * @author manfredi
 */
public class InserimentoCFBNDBisogni extends javax.swing.JFrame {
    ...
    public InserimentoCFBNDBisogni() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inserisci il CF del componente del quale modificare i bisogni");
    ...
    private void InserisciButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InserisciButtonActionPerformed
        this.gestioneFamiglieControl.verificaCFBisogni(this.CFInseritoText.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InserimentoCFBNDBisogni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InserimentoCFBNDBisogni().setVisible(true);
            }
        });
    }

 ...
 * @author manfredi
 */
public class InserimentoComponentiBND extends javax.swing.JFrame {

    /**
     * Creates new form InserimentoComponentiBND
     */
    
    GestioneFamiglieControl gestioneFamiglieControl;
    
    public InserimentoComponentiBND() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inserimento Componenti");

        AggiungiButton.setText("Aggiungi Nuovo Componente");
    ...
    private void AggiungiButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AggiungiButtonActionPerformed
        ...
        this.gestioneFamiglieControl.createInserimentoDatiBND();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InserimentoComponentiBND.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InserimentoComponentiBND().setVisible(true);
            }
        });
    }
